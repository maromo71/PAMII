    ...
    return(
        <div>
            ...
            <div className="lista">
                ...
                <ListItem signo="Câncer" imagem="assets/cancer.jpg" dataInicio="21/06" dataFim="22/07"/>
                <ListItem signo="Leão" imagem="assets/leao.jpg" dataInicio="23/07" dataFim="22/08"/>
                ...
                <ListItem signo="Capricornio" imagem="assets/capricornio.jpg" dataInicio="22/12" dataFim="19/01"/>   
            </div>
        </div>
    );
}